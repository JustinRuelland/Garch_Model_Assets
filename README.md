...
- Fichier **puissance_test_chgtGARCH.R** : fichier qui simule une "carte bleue" (=représentation des zones de rejet de test dans le cadre d'une simulation GARCH(1,1) avec changement de GARCH à un "cut")
